...
iface0 = node_webserver.addInterface('interface-1', pg.IPv4Address('10.1.1.2','255.255.255.0'))
...
iface1 = node_observer.addInterface('interface-0', pg.IPv4Address('10.1.1.1','255.255.255.0'))
